...
public class RandomNameUtil {
     ...
     * 常用单姓
     */
    private static String surNameArray[] = {
     ...
     * 常见复姓
     */
    private static String doubleSurNameArray[] = {"万俟", "司马", "上官", "欧阳", "夏侯", "诸葛", "闻人", "东方",
     ...
     * 常用字
     */
    private static String[] wordArray = {"一", "乙", "二", "十", "丁", "厂", "七", "卜", "人", "入", "八", "九", "几", "儿", "了", "力", "乃", "刀", "又",
     ...
     * 生成随机名称
     *
     * @param simple 是否复姓 true 不需要 false 需要
     * @param len    名字的长度
     * @return
     */
    public static String randomName(boolean simple, int len) {

        int surNameLen = surNameArray.length;
        int doubleSurNameLen = doubleSurNameArray.length;
        ...
        if (simple) {
            //不是复姓
            surName = surNameArray[random.nextInt(surNameLen)];
        } else {
            //是复姓
            surName = doubleSurNameArray[random.nextInt(doubleSurNameLen)];
        }

        return randomName(surName, len);
    }
     ...
     * @return
     */
    public static String randomName(String surName, int len) {

        AssertUtil.hasText(surName, "姓不能为空");
        ...
        //取剩下的名字
        for (int i = 0; i < len - surName.length(); i++) {
            if (sb.toString().length() <= len) {
                sb.append(wordArray[random.nextInt(wordLen)]);
            }
        }
